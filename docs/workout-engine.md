...
| Input                       | Owner                               | Effect                                                                                                                                                                                                                                                                                                                                                          |
| --------------------------- | ----------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Goals and style             | `src/engine/volume/weeklyVolume.ts` | Goal weights per muscle (priority muscles up to 1.6), weekly set targets, template choice. One rule: the goal decides where the weekly volume goes, the programming style decides how each set is done. More overall size leads with legs, back, and chest; Strength progress adds Full body to the rotation; the retired Balanced choice reads as Build muscle |
