...
const smokeSpecs =
  /(smoke|onboarding|library|duration|recalibration|activeWorkout|startingLoads|coachRound|cloud|coach|progress|media|dataSafety|a11y|zoom|screenshots)\.spec\.ts/;
