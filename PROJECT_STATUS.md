...
| Latest commit          | `de72b64` Phase 3 fix: own database name plus version-collision recovery (this docs update follows it)                                                                                                           |
| Latest deployment      | `de72b64` deployed by Deploy Pages run 33721261871 (success); verified live with 36 browser tests and a real-browser reproduction of the reported collision                                                      |
