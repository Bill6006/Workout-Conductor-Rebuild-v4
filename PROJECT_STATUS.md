...
| Work in progress       | Maintenance 15 (round E) on the owner's go of 2026-09-18: more research-based programming styles, with the goals and settings choosing the style. Maintenance 14 stays at its review gate (`docs/reports/maintenance-14.md`)                                                                              |
| Latest commit          | Status and live screenshots for build `3edb0b3` (this commit); app build under review is `3edb0b3`                                                                                                                                                                                                        |
| Latest deployment      | `3edb0b3` deployed by Deploy Pages run 35412408347 (success); browser suite against the live URL: 210 passed + 14 skipped by design (one cloud-recovery test timed out on the first pass and held back the two installed-app tests; it passed 3 of 3 on rerun and the two passed when run)                |
| Test totals            | Unit: 498 passed (112 files). Browser/mobile: 210 passed + 14 skipped by design locally and 210 passed + 14 skipped by design (one cloud-recovery test timed out on the first pass and held back the two installed-app tests; it passed 3 of 3 on rerun and the two passed when run) against the live URL |
