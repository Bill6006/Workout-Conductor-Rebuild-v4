...
| Current phase          | Plan complete (Phases 0 to 8 GREEN); Maintenance 1 to 3, 6, 7, 12, 13, and 18 GREEN; 4, 5, 8, 9, 10, 11, 14, 15, 16, and 17 at their review gates. Maintenance 19, round A (mid-workout), at its review gate    |
| Phase gate             | Maintenance 19 **YELLOW** - built, deployed, and verified against the live URL; awaiting the owner's Android review (issue #20). Maintenance 4, 5, 8, 9, 10, 11, 14, 15, 16, and 17 YELLOW (reviews still open) |
| Current branch         | `main`                                                                                                                                                                                                          |
| Latest completed phase | Phase 6 (GREEN from the owner on 2026-09-03)                                                                                                                                                                    |
| Work in progress       | None. Maintenance 19 is at its review gate (`docs/reports/maintenance-19.md`). Agreed and not started: items 1 (hold timer) and 3 (pain you can trust), as Round B, on the owner's go                           |
| Latest commit          | Status and live screenshots for build `9fd2794` (this commit); app build under review is `9fd2794`                                                                                                              |
...
## Maintenance 19: round A, what happens mid-workout (YELLOW - awaiting review)
