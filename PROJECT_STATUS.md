...
| Current phase          | Plan complete (Phases 0 to 8 GREEN); Maintenance 1 to 3, 6, 7, 12, and 13 GREEN; 4, 5, 8, 9, 10, 11, and 14 at their review gates. Maintenance 15, programming styles chosen by the goals (round E), at its review gate                                    |
| Phase gate             | Maintenance 15 **YELLOW** - built, deployed, and verified against the live URL; awaiting the owner's Android review (issue #16). Maintenance 4, 5, 8, 9, 10, 11, and 14 YELLOW (reviews still open)                                                        |
| Current branch         | `main`                                                                                                                                                                                                                                                     |
| Latest completed phase | Phase 6 (GREEN from the owner on 2026-09-03)                                                                                                                                                                                                               |
| Work in progress       | None. Maintenance 15 is at its review gate (`docs/reports/maintenance-15.md`). The owner's third list is complete; the items under Proposed wait for his word                                                                                              |
| Latest commit          | Status and live screenshots for build `91d0234` (this commit); app build under review is `91d0234`                                                                                                                                                         |
| Latest deployment      | `91d0234` deployed by Deploy Pages run 35415701824 (success); browser suite against the live URL: 219 passed + 14 skipped by design, none failed                                                                                                           |
| Test totals            | Unit: 556 passed (119 files). Browser/mobile: 219 passed + 14 skipped by design (on the final commit two first-page-load timeouts at the start of the run passed on rerun) locally and 219 passed + 14 skipped by design, none failed against the live URL |
