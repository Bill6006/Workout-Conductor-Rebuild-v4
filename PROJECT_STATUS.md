...
| Work in progress       | None in progress: Maintenance 21 (round C: the owner's items 15 to 20, plus the fix from the owner's review: the Smith machine at Home) is built, deployed, and at its review gate. Agreed and waiting: 1 to 8, 10 to 12, 14, 21, 22 (warm-ups on bodyweight lifts, as the research says: `docs/research/bodyweight-warm-ups.md`), and 30 (a switch per machine between a pin stack and plates, starting with which machines come both ways) |
| Latest commit          | Maintenance 21 fix status and capture (this commit); the fix's build is `4bce35a`, the round's build `5c2aee6`                                                                                                                                                                                                                                                                                                                               |
| Latest deployment      | `4bce35a` deployed by Deploy Pages run 35894585947 (success); browser suite against the live URL: 270 passed + 14 skipped by design, none failed                                                                                                                                                                                                                                                                                             |
| Test totals            | Unit: 717 passed (141 files). Browser/mobile: 270 passed + 14 skipped by design, none failed (four active-workout load timeouts in the gate passed when that file was rerun one test at a time) locally; against the live URL: 270 passed + 14 skipped by design, none failed                                                                                                                                                                |
...
hints in full; and, for the fix, a set logged at the gym, then Home and another change: a Home
exercise stays right after the stopped one.
