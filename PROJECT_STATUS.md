...
| Current phase          | Plan complete (Phases 0 to 8 GREEN); Maintenance 1 to 3, 6, 7, 12, 13, 18, 19, and 20 GREEN; 4, 5, 8, 9, 10, 11, 14, 15, 16, 17, 21, and 22 at their review gates                                                                                                                                                                                                                                                                                                                            |
| Phase gate             | Maintenance 22 **YELLOW**, awaiting the owner's review (issue #23). Maintenance 21 YELLOW (issue #22). Maintenance 4, 5, 8, 9, 10, 11, 14, 15, 16, and 17 YELLOW (reviews still open)                                                                                                                                                                                                                                                                                                        |
| Current branch         | `main`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Latest completed phase | Phase 6 (GREEN from the owner on 2026-09-03)                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Work in progress       | None in progress: Maintenance 22 (round D: the owner's items 29, 28 and 23, swaps you can trust) is built, deployed, and at its review gate. Agreed and waiting: 1 to 8, 10 to 12, 14, 21, 22 (warm-ups on bodyweight lifts, as the research says: `docs/research/bodyweight-warm-ups.md`), 24 to 27, 30 (a switch per machine between a pin stack and plates, starting with which machines come both ways), and 31. Proposed: 32 (a second workout the same day leads with what was missed) |
| Latest commit          | Maintenance 22 status and captures (this commit); the round's build is `95fe897`                                                                                                                                                                                                                                                                                                                                                                                                             |
| Latest deployment      | `95fe897` deployed by Deploy Pages run 35949230067 (success); browser suite against the live URL: 279 passed + 14 skipped by design, none failed (the swaps tests rerun with clean screenshots: 9 passed)                                                                                                                                                                                                                                                                                    |
| Test totals            | Unit: 827 passed (147 files). Browser/mobile: 279 passed + 14 skipped by design, none failed, locally in the gate; against the live URL: 279 passed + 14 skipped by design, none failed (the swaps tests rerun with clean screenshots: 9 passed)                                                                                                                                                                                                                                             |
...
## Maintenance 22: round D, swaps you can trust (YELLOW - awaiting review)
...
Owner reviews Maintenance 22 on an Android phone (issue #23): log a set of an exercise, then
swap it: Today reads "Stopped: 1 of N sets done", the new exercise follows with its own
target, and the stopped one's sheet says which exercise took over; swap back and it picks up
again; turn on "Keep it for the next 4 weeks" in a sheet and swap, then see it on the Plan tab
with Stop. Maintenance 21 (issue #22) is still open too.
