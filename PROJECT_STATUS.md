...
| Latest commit          | Maintenance 24 status, report verification, and live captures (this commit); the live app build it deploys is the same app code as `4f63e3d`, the two things to settle decided from the evidence                                                         |
